output "vpc" {
#   value = [
#     "${module.dev.vpc}        ${module.dev.cidr_block}"
#   ]
# }

# output "public_subnets" {
#   value = [
#     "${module.dev.public_subnet1}     ${aws_subnet.public_subnet1.cidr_block}     ${aws_subnet.public_subnet1.availability_zone}" ,
#     "${module.dev.public_subnet2}     ${aws_subnet.public_subnet2.cidr_block}     ${aws_subnet.public_subnet2.availability_zone}" ,  
#     "${module.dev.public_subnet3}     ${aws_subnet.public_subnet3.cidr_block}     ${aws_subnet.public_subnet3.availability_zone}"
#   ] 
# }
